...
function initialize(){
    ...
    var metaballsGroup1 = {
        ...
        texture:generateGradientTexture([{color:'#9cca5b', stop:1.0}], false, false)
    };
    var metaballsGroup2 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:'#9cca5b', stop:.7}], true, false)
    };
    var metaballsGroup3 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:'#9cca5b', stop:.7}], false, false)
    };
    var metaballsGroup4 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:'#9cca5b', stop:.4}], false, false)
    };
    var metaballsGroup5 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:'#9cca5b', stop:0.78}], true, false)
    };
    var metaballsGroup6 = {
        metaballs:[
            { centerOffsetX:740 * scale, centerOffsetY:20 * scale, radius: 70 * scale, speed: getRandomFloat(minSpeed, maxSpeed), t:Math.random() * 200, arcMultiplierX:getRandomFloat(minMultiplierArcX, maxMultiplierArcX), arcMultiplierY:getRandomFloat(minMultiplierArcY, maxMultiplierArcY) },
...
function generateGradientTexture(colors, vertical, debug) {
    ...
    colors = colors || [{color:'#9cca5b', stop:1.0}];
